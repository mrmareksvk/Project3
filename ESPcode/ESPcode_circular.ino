...
CircularBuffer<float,25> temp_stor;                 // ~240bytes
CircularBuffer<float,25> hum_stor;                  // ~240bytes
CircularBuffer<int,25> light_stor;                  // ~240bytes
CircularBuffer<double,25> lat_stor;                 // ~500bytes
CircularBuffer<double,25>lon_stor;                  // ~500bytes
CircularBuffer<uint32,25>data_stor;                 // ~500bytes
CircularBuffer<uint32,25>time_stor;                 // ~500bytes
